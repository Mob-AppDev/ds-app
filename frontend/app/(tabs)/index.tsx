...
/**
 * Home screen combining the best elements from AL and Mike implementations
 * Features unified workspace and channel management with DevSync branding
 */
      ...
      <SafeAreaView style={styles.userModalContainer}>
        ...
        <View style={styles.userProfile}>
          ...
          <View style={styles.userInfo}>
            <Text style={styles.userName}>DevSync User</Text>
      ...
      <View style={styles.header}>
        <View style={styles.workspaceInfo}>
          <View style={styles.workspaceIcon}>
            <Text style={styles.workspaceIconText}>DS</Text>
          </View>
          <Text style={styles.workspaceName}>DevSync Workspace</Text>
        </View>
        <TouchableOpacity 
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/chat/all-dms')}>
              <Text style={styles.showAllText}>Show all {unreadDMs.length}</Text>
            </TouchableOpacity>
          </View>
