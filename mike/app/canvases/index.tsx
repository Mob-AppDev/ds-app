...
const templates = [
  ...
  { id: 'tpl7', title: 'Bug Report', description: 'Structured bug reporting template' },
  { id: 'tpl8', title: 'User Research', description: 'User interviews, surveys, and insights' },
];
    ...
    switch (template) {
      case 'Meeting Notes':
        return [
          ...
          { id: '5', type: 'header', content: 'Notes' },
          { id: '6', type: 'text', content: 'Add your meeting notes here...' },
          { id: '7', type: 'header', content: 'Action Items' },
          { id: '8', type: 'list', content: '- [ ] [Action item 1] - [Assignee]\n- [ ] [Action item 2] - [Assignee]' },
        ];
      case 'Project Brief':
        return [
          { id: '1', type: 'header', content: 'Project Brief' },
          { id: '2', type: 'text', content: 'Project: [Project Name]\nClient: [Client Name]\nTimeline: [Timeline]' },
          { id: '3', type: 'header', content: 'Project Overview' },
          { id: '4', type: 'text', content: 'Brief description of the project goals and objectives...' },
          { id: '5', type: 'header', content: 'Requirements' },
          { id: '6', type: 'list', content: '- [Requirement 1]\n- [Requirement 2]\n- [Requirement 3]' },
          { id: '7', type: 'header', content: 'Deliverables' },
          { id: '8', type: 'list', content: '- [Deliverable 1]\n- [Deliverable 2]\n- [Deliverable 3]' },
        ];
      case 'Retrospective':
        return [
          { id: '1', type: 'header', content: 'Sprint Retrospective' },
          { id: '2', type: 'text', content: 'Sprint: [Sprint Name]\nDate: [Date]\nTeam: [Team Members]' },
          { id: '3', type: 'header', content: 'What Went Well' },
          { id: '4', type: 'list', content: '- [Positive aspect 1]\n- [Positive aspect 2]' },
          { id: '5', type: 'header', content: 'What Could Be Improved' },
          { id: '6', type: 'list', content: '- [Improvement area 1]\n- [Improvement area 2]' },
          { id: '7', type: 'header', content: 'Action Items' },
          { id: '8', type: 'list', content: '- [ ] [Action item 1]\n- [ ] [Action item 2]' },
        ];
      default:
        return [
